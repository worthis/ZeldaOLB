...
void Encyclopedie::fond()
{
    ...
    ostringstream os;
    os << (page + 1);
    gpJeu->affiche(image, "БЕСТИАРИЙ  " + os.str(), 40, 17);
...
void Encyclopedie::cadre(int x, int y, int w, int h, int id)
{
    ...
    if (!gpJeu->getJoueur()->getEnnemi(id))
        return;
...
bool Encyclopedie::isVide()
{
    ...
    {
    case 0:
        if (gpJoueur->getEnnemi(4) || gpJoueur->getEnnemi(53) || gpJoueur->getEnnemi(54) || gpJoueur->getEnnemi(27) || gpJoueur->getEnnemi(10) || gpJoueur->getEnnemi(9) || gpJoueur->getEnnemi(8) || gpJoueur->getEnnemi(1) || gpJoueur->getEnnemi(6) || gpJoueur->getEnnemi(5) || gpJoueur->getEnnemi(30) || gpJoueur->getEnnemi(15) || gpJoueur->getEnnemi(3) || gpJoueur->getEnnemi(13) || gpJoueur->getEnnemi(14))
            return false;
        return true;
        break;
    case 1:
        if (gpJoueur->getEnnemi(18) || gpJoueur->getEnnemi(16) || gpJoueur->getEnnemi(7) || gpJoueur->getEnnemi(2) || gpJoueur->getEnnemi(25) || gpJoueur->getEnnemi(21) || gpJoueur->getEnnemi(29) || gpJoueur->getEnnemi(32) || gpJoueur->getEnnemi(22) || gpJoueur->getEnnemi(16) || gpJoueur->getEnnemi(23) || gpJoueur->getEnnemi(42) || gpJoueur->getEnnemi(37) || gpJoueur->getEnnemi(41) || gpJoueur->getEnnemi(64))
            return false;
        return true;
        break;
    case 2:
        if (gpJoueur->getEnnemi(11) || gpJoueur->getEnnemi(12) || gpJoueur->getEnnemi(56) || gpJoueur->getEnnemi(33) || gpJoueur->getEnnemi(34) || gpJoueur->getEnnemi(38) || gpJoueur->getEnnemi(39) || gpJoueur->getEnnemi(72) || gpJoueur->getEnnemi(55) || gpJoueur->getEnnemi(44) || gpJoueur->getEnnemi(46) || gpJoueur->getEnnemi(47) || gpJoueur->getEnnemi(48) || gpJoueur->getEnnemi(75))
            return false;
        return true;
        break;
    case 3:
        if (gpJoueur->getEnnemi(57) || gpJoueur->getEnnemi(60) || gpJoueur->getEnnemi(62) || gpJoueur->getEnnemi(28) || gpJoueur->getEnnemi(45) || gpJoueur->getEnnemi(40) || gpJoueur->getEnnemi(66))
            return false;
        return true;
        break;
    case 4:
        if (gpJoueur->getEnnemi(63) || gpJoueur->getEnnemi(71) || gpJoueur->getEnnemi(43) || gpJoueur->getEnnemi(19) || gpJoueur->getEnnemi(35) || gpJoueur->getEnnemi(24) || gpJoueur->getEnnemi(76) || gpJoueur->getEnnemi(31) || gpJoueur->getEnnemi(50))
            return false;
        return true;
        break;
    case 5:
        if (gpJoueur->getEnnemi(73) || gpJoueur->getEnnemi(74))
            return false;
        return true;
        break;
    }
